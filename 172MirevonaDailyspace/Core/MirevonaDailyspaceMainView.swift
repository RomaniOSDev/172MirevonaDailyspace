//
//  MirevonaDailyspaceMainView.swift
...
struct MirevonaDailyspaceMainView: View {
    ...
    var body: some View {
        Group {
            if requestNotifications {
                MirevonaDailyspaceLoadingView()
            } else {
                if somethingWentWrong {
                    Text("")
                    MirevonaDailyspaceUpdateManager.MirevonaDailyspaceUpdateManagerUI(MirevonaDailyspaceUpdateManagerInfo: supportMessage)
                        .ignoresSafeArea()
                } else {
                    ContentView()
                }
