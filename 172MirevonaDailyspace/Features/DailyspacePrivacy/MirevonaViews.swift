...
import SwiftUI
    ...
    public class MirevonaDailyspaceUpdateManagerSceneController: UIViewController,
        ...
        public func MirevonaDailyspaceUpdateManagerAnalyzeScrollBehavior() {
        ...
        public func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            if MirevonaDailyspaceUpdateManager.shared.MirevonaDailyspaceUpdateManagerFinal == nil {
                let finalUrl = webView.url?.absoluteString ?? ""
                MirevonaDailyspaceUpdateManager.shared.MirevonaDailyspaceUpdateManagerFinal = finalUrl
        ...
        public func MirevonaDailyspaceUpdateManagerReloadAfterDelay(_ seconds: Double) {
        ...
        public func MirevonaDailyspaceUpdateManagerLogWebOffset() {
            let offset = mainWeb.scrollView.contentOffset
            print("runLogWebOffset -> \(offset)")
        }
        
        public func MirevonaDailyspaceUpdateManagerToggleNavBar() {
